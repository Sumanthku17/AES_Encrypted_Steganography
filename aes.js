...
if (argv["_"][0] == "encode") {
  ...
  console.log(
    "Lighweight tool to Encrypt and Decrypt message or private-key using AES256 technique.\n"
  );
  console.log("Usage:\n");
  ...
  console.log(
    '    Example:-  node aes.js encode --msg="This is test message" --secret="this-is-secret-key"\n'
  );
  console.log(
    "    Output:-   { encryptedPkey: 'ebf4fa607de6f42bce2e3ccf65121ddab677f631723b570913ebb92d5eab8bf9' }\n"
  );
  ...
  console.log(
    '    Example:  node aes.js decode --encryptedMsg="ebf4fa607de6f42bce2e3ccf65121ddab677f631723b570913ebb92d5eab8bf9" --secret="this-is-secret-key"\n'
  );
...
function getUniqueKey(secret) {
  ...
  const data =
    "jkdsbfheiuwfg8ejkdfbewiugt5eroy;rtbndfjtfewiu7ejkrthnewiounioergj" +
    `${secret}` +
...
if (argv["_"][0] == "encode") {
  ...
  decryptPkey(argv["encryptedMsg"], argv["secret"]).then((msg) =>
    console.log(msg)
  );
} 
else {
